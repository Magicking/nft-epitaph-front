...
declare const __propDef: {
    props: {
        width?: number;
        addEventListener?: {
            <K extends keyof HTMLElementEventMap>(type: K, listener: (this: HTMLPreElement, ev: HTMLElementEventMap[K]) => any, options?: boolean | AddEventListenerOptions): void;
            (type: string, listener: EventListenerOrEventListenerObject, options?: boolean | AddEventListenerOptions): void;
        };
        removeEventListener?: {
            <K_1 extends keyof HTMLElementEventMap>(type: K_1, listener: (this: HTMLPreElement, ev: HTMLElementEventMap[K_1]) => any, options?: boolean | EventListenerOptions): void;
...
export declare type HighlightSvelteProps = typeof __propDef.props;
export declare type HighlightSvelteEvents = typeof __propDef.events;
export declare type HighlightSvelteSlots = typeof __propDef.slots;
export default class HighlightSvelte extends SvelteComponentTyped<HighlightSvelteProps, HighlightSvelteEvents, HighlightSvelteSlots> {
}
export {};
