 ...
 */
declare const defaultEvmStores: DefaultEVMStore;
/**
 * `true` if connection to the provider was successful for `defaultEvmStores`.
 */
declare const connected: DefaultEVMStore["connected"];
/**
 * The current chainId of `defaultEvmStores` if connected.
 */
declare const chainId: DefaultEVMStore["chainId"];
/**
 * Store value is a shortcut to get `$signer.getAddress()` when connected.
 */
declare const signerAddress: DefaultEVMStore["signerAddress"];
/**
 * A stored Ethers.js Provider instance when connected.
 */
declare const provider: DefaultEVMStore["provider"];
/**
 * A stored Ethers.js Signer instance when connected.
 */
declare const signer: DefaultEVMStore["signer"];
/**
 * Current selected account address if connected, `null` otherwise.
 */
declare const selectedAccount: DefaultEVMStore["selectedAccount"];
/**
 ...
 */
declare const contracts: Readable<Record<string, Contract>>;
 ...
 */
declare const allChainsData: ChainData[];

export { ChainData, DefaultEVMStore, allChainsData, chainId, connected, contracts, defaultEvmStores, provider, selectedAccount, signer, signerAddress };
